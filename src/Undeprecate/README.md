...
There is also a journey mode player save file available for download, with all items researched and all of the deprecated items in the inventory, if you prefer that.
